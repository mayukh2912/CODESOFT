...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text="PASSWORD GENERATOR", anchor=N, fg='azure', bg='black', font='helvetica 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='black', fg='goldenrod')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='black', fg='goldenrod')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='black', fg='goldenrod')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='Verdana", 15 bold', fg='black', bg='goldenrod', command=self.generate_pass)
        self.generate.grid(row=11, column=1)

        self.blank_label5 = Label(text="")
        self.blank_label5.grid(row=12, column=0)

        self.accept = Button(text="ACCEPT", bd=3, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='black', bg='goldenrod', command=self.accept_fields)
        self.accept.grid(row=13, column=1)

        self.blank_label1 = Label(text="")
        self.blank_label1.grid(row=14, column=1)

        self.reset = Button(text="RESET", bd=3, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='black', bg='goldenrod', command=self.reset_fields)
